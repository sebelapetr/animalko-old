	...
	<section>
      ...
      <div class="col-sm-3">                              
        <div class="col-sm-12" style="padding:0;margin-bottom:15px;border:1px solid #0003">
                ...
                */ 
                $query_total = $mysqli->query("SELECT nazev, jmeno_kategorie from kategorie where jmeno_kategorie='$page'");           
                $row_total = $query_total->fetch_assoc();   
                $row_total = explode('/',$row_total['jmeno_kategorie']);    
                $query_total = $mysqli->query("SELECT nazev,jmeno_kategorie from kategorie where jmeno_kategorie='$row_total[0]/'");           
                $row_total = $query_total->fetch_assoc();             
                          echo '<div class="col-sm-12" style="background:#f3f3f3">    
                                  <a href="?p='.$row_total['jmeno_kategorie'].'">
                                        <h3 style="color:black;text-decoration:;font-weight:400;font-size:18px;margin:15px 0;">'.$row_total['nazev'].'</i></h3>   
                                     </a>  
                                </div>';                  
                $query_nadpis = $mysqli->query("SELECT nazev, jmeno_kategorie from kategorie where jmeno_kategorie='$page'");           
                $row_nadpis = $query_nadpis->fetch_assoc();  
                if($row_nadpis['nazev']!==$row_total['nazev']){
                          echo '<div class="col-sm-12" style="background:#fbfbfb;">   
                                        <h3 style="color:black;font-weight:400;font-size:16px;margin:15px 0;margin-left:10px">'.$row_nadpis['nazev'].'</i></h3>  
                                </div>';  
                        ...
                        /*
                          ...
                          */
                          echo '<div class="col-sm-12">  
                                    <a href="?p='.$row_kat['jmeno_kategorie'].'"> 
                                        <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;margin-left:20px">'.$row_kat['down1_name'].' <i class="fa fa-next pull-right"></i></h3>  
                                    </a> 
                                </div>';                                                               
                        }
                        else{}
        ...
        <?php    
                ...
                $query_length = $mysqli->query("select distinct zakoupen,jmeno_znacka from produkt where kategorie like '$kategorie%' order by zakoupen desc limit 5");  
                while ($row_length = $query_length->fetch_assoc()) { 
      ...
      ?>
      <div class="col-sm-12" style="border:1px solid #0003;padding:0">
        <div class="col-sm-12" style="background:#f3f3f3;margin:0">   
          <h3 style="color:black;font-weight:400;font-size:15px;margin:15px 0;">Varianty<i class="fa fa-filter pull-right"></i></h3>   
        </div>
        <div class="col-sm-12" style="<?php echo $var1;?>">                    
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=1&amp;max=400&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t1;?>">0 - 200g<i class="fa fa-next pull-right"></i></h3>  
          </a> 
        </div> 
        <div class="col-sm-12" style="<?php echo $var2;?>">  
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=150&amp;max=700&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t2;?>">200 - 500g <i class="fa fa-next pull-right"></i></h3>  
          </a> 
        </div>  
        <div class="col-sm-12" style="<?php echo $var3;?>">  
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=400&amp;max=1300&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t3;?>">500g - 1kg<i class="fa fa-next pull-right"></i></h3>  
          </a>
          
        </div>  
        <div class="col-sm-12" style="<?php echo $var4;?>">  
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=900&amp;max=2500&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t4;?>">1kg - 2kg<i class="fa fa-next pull-right"></i></h3>  
          </a>
          
        </div>  
        <div class="col-sm-12"  style="<?php echo $var5;?>">  
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=1900&amp;max=6000&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t5;?>">2kg - 5kg<i class="fa fa-next pull-right"></i></h3>  
          </a>
          
        </div> 
        <div class="col-sm-12"  style="<?php echo $var6;?>">  
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=4900&amp;max=12000&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t6;?>">5kg - 10kg<i class="fa fa-next pull-right"></i></h3>  
          </a>
          
        </div> 
        <div class="col-sm-12"  style="<?php echo $var7;?>">  
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=9900&amp;max=1000000&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t7;?>">> 10kg<i class="fa fa-next pull-right"></i></h3>  
          </a>
          
        </div> 
        <div class="col-sm-12" style="<?php echo $var8;?>">  
          <a href="<?php echo '?p='.$page.'&amp;strana=1&amp;razeni='.$razeni.'&amp;min=0&amp;max=1000000&amp;znacka='.$znacka.''; ?>"> 
            <h3 style="color:black;text-decoration:;font-weight:300;font-size:14px;margin:15px 0;<?php echo $var_t8;?>">Všechny varianty<i class="fa fa-next pull-right"></i></h3>  
          </a>
      ...
      <div class="col-sm-9">     
       ...
       <div class="col-sm-3" style="margin-top:15px;padding-left:0px;padding-right:0px;"> 
                ...
                <?php                                                                         
                 $query = $mysqli->query("SELECT DISTINCT jmeno_znacka, zakoupen FROM produkt WHERE kategorie LIKE '$kategorie%' order by zakoupen desc limit 10;");    
                 while ($row = $query->fetch_assoc()) {                                       
          ...
          <?php require "design/cesta.php";?>
                ...
                */ 
                $query_nadpis = $mysqli->query("SELECT nazev,jmeno_kategorie from kategorie where jmeno_kategorie='$page'");  
                $row_nadpis = $query_nadpis->fetch_assoc();   
                echo '<div class="col-sm-12"  style="padding-right:0px;padding-left:0px;"><h3 style="font-weight:300;margin-bottom:10px">'.$row_nadpis['nazev'].'</h3></div>';                  
                echo '
    						<div class="col-sm-12" style="margin-bottom:10px;padding:0">';      
                    $query_kat = $mysqli->query("select root.jmeno_kategorie, root.nazev   as root_name
                                                                   , down1.jmeno_kategorie, down1.obrazek, down1.nazev as down1_name 
                ...
                //echo "SELECT id_produkt, katalog_cena_DPH, obrazek, jmeno_produkt, url from produkt where kategorie in ($string) LIMIT $limit OFFSET $offset<br>"; 
                 ...
                 $min_k=$min;
                 $max_k=$max;
                  $query3 = $mysqli->query("SELECT skladem, info_sklad,sklad_pocet, id_produkt, katalog_cena_DPH, obrazek, jmeno_produkt, url, popis from produkt where kategorie in ($string) and vaha < $max_k and vaha >= $min_k and jmeno_znacka like '%$znacka%' ORDER BY $serazeni LIMIT $limit OFFSET $offset"); 
                  $query_nmb = $mysqli->query("SELECT COUNT(id_produkt) from produkt where kategorie in ($string) and vaha < $max and vaha >= $min and jmeno_znacka like '%$znacka%'");
                 }
                 else{
                  $query3 = $mysqli->query("SELECT skladem, info_sklad,sklad_pocet, id_produkt, katalog_cena_DPH, obrazek, jmeno_produkt, url, popis from produkt where kategorie in ($string) and jmeno_znacka like '%$znacka%' ORDER BY $serazeni LIMIT $limit OFFSET $offset"); 
                  $query_nmb = $mysqli->query("SELECT COUNT(id_produkt) from produkt where kategorie in ($string) and jmeno_znacka like '%$znacka%'");
                 }    
                  ...
                  <form method="post" action="?p='.$page.'?action=add&id='.$row3["id_produkt"].'" target="formDestination">      
                   ...
                   echo'
                      ...
                      <hr style="margin:8px;">
        											<p>
                              <a href="?p='.($row3['url']).'">'.html_entity_decode($row3['jmeno_produkt']).'</a> 
                              <h2>'.$cena.' Kč</h2>     
                              '.$stringos.' 
            ...
            <div class="col-sm-12">   
              ...
              if (substr($kategorie, 0, 6) == "Krmivo"){
                $min_s = $min;
                $max_s = $max;
                $query_nb = $mysqli->query("SELECT COUNT(id_produkt) FROM produkt WHERE kategorie in ($string) and vaha < $max_s and vaha >= $min_s and jmeno_znacka like '%$znacka%'"); 
              ...
              if ($strana_limit==$pocet_pr){
               ...
               break;  
                ...
                $query_nb = $mysqli->query("SELECT COUNT(id_produkt) FROM produkt WHERE kategorie in ($string) and jmeno_znacka like '%$znacka%'");
      $row_nb = $query_nb->fetch_assoc();    
              $produktu = $row_nb['COUNT(id_produkt)'];
              $pocet_pr1 = $produktu/15;  
              $pocet_pr = ceil($produktu/15);                   
